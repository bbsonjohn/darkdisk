...
def parameterMatter(hDD, SigDD, rhoDHalo = 0.008, sigmaDHalo = 130.):
   ...
   if SigDD == 0.:
       sigma = [sigmaH2, sigmaHI1, sigmaHI2, sigmaWGas, sigmaGiants, sigmaMV2p5, sigma3MV4, sigma4MV5, sigma5MV8, sigmaMV8, sigmaWDwarfs, sigmaBDwarfs, sigmaTDisk, sigmaSHalo, sigmaDHalo]
       rho = [rhoH2, rhoHI1, rhoHI2, rhoWGas, rhoGiants, rhoMV2p5, rho3MV4, rho4MV5, rho5MV8, rhoMV8, rhoWDwarfs, rhoBDwarfs, rhoTDisk, rhoSHalo, rhoDHalo]
       return [sigma, rho]
