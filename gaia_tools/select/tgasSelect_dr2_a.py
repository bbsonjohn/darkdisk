...
class tgasSelect(object):
    def __init__(self,
                 ...
                 max_scd=0.7,
                 min_lat=20.,
                 jmin=2.,jmax=13.5,jkmin=-0.05,jkmax=1.05):
        """#
        NAME:
           __init__
        PURPOSE:
        ...
        m1,m2,sep= gaia_tools.xmatch.xmatch(self._full_twomass,self._full_tgas,
                                            ...
                                            epoch1=2000.,epoch2=2015.5,swap=True) #2015.5 for DR2
    ...
    def _determine_selection(self,jmin,jmax,jkmin,jkmax):
        ...
        part of the sky"""
        to_plot = True #John: whether to do the 2d density plot
        ...
        if to_plot:
            ...
            plt.xlabel('$J-K_s$', fontsize=13); plt.ylabel('$J$', fontsize=13)
            fit_completeness = []
            ...
            cbar = plt.colorbar(); cbar.set_label("effective completeness", fontsize=13)
