...
The python notebooks serve as a narration of high the data is generated from the raw Gaia data. Readers can follow the reading sequence of *gaia_cut* $\rightarrow$ *exclusion_plot* $\rightarrow$ *emcee_gaia*. The computationally simplifed version of the main result is featured in emcee_gaia.ipynb.

Result for the likelihood-frequentist exclusion contour.
![95% exclusion contour in the dark disk parameter plane.](Plots/emcee.png?raw=true "Title")
